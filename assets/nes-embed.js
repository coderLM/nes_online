...
function audio_callback(event) {
	...
	//len == 512
	// console.log("audio_callback len:"+len);
...
function nes_load_url(canvas_id, path) {
	...
	req.onload = function () {
		if (this.status === 200) {
			...
			//length == 40976
			console.log("nes_load_url", this.responseText.length);
...
//open -n /Applications/Google\ Chrome.app/ --args --disable-web-security  --user-data-dir=/Users/sm-li/MyChromeDevUserData